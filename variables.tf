...
variable "aws_default_region" {
  description = "The defalt region that all resources will be deployed into."
  type        = string
...
variable "ami_id" {
  ...
  type        = string
  default     = "ami-00bc9b7f0e98dc134" # Latest Ubuntu 18.04 LTS (HVM), SSD Volume Type
}
...
# Allowed Traffic into the load balancer
